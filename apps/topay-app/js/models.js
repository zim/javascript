...
// 		
		// console.log("displayDebit this.domElement = " + this.domElement);
// 		
// 		
		// var debitElement = document.createElement('div');
// 		
		// debitElement.id = this.name + "_id";
		// debitElement.setAttribute('class','debit_element');
// 		
		// // this.domElement.appendChild(debitElement);
		// //this.domElement.appendChild(debitElement);
// 		
		// var debitNameElement = document.createElement('p');
		// debitNameElement.innerHTML = this.name;
// 		
		// //debitElement.appendChild(debitNameElement);
// 		
// 		
	    // // var debitToDisplay = "<div class='debit'><div class='debit-name'>" + this.name + "</div>";
	        // // debitToDisplay += "<div class='debit-date'>" + this.value + "</div>";
	        // // debitToDisplay += "<div class='debit-value'>" + this.startDate + "</div>";
	        // // debitToDisplay += "<div class='debit-payed'>" + this.payed + "</div></div>";
// 	        
// 	    
// 	
...
// 		
// 	
	    // //console.log (debitToDisplay);
// 	
	// };// end Question.prototype.displayDebit = function ()
